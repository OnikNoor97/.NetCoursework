...
namespace NetCw.Controllers
{
    ...
    public class AnnouncementsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AnnouncementsID,Title,Message")] Announcements announcements)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AnnouncementsID,Title,Message")] Announcements announcements)
        {
            if (ModelState.IsValid)
            {
